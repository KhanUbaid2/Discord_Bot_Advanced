...
const Giveaway = require('../Schemas/giveawaySchema'); // Update with the correct path
const {generateRandomCode, convertToMilliseconds, convertUnix} = require("../functions/generate")
...
async function startGiveaway(interaction, client) {
    ...
    const embed = new EmbedBuilder()
        .setTitle("🎉 Giveaway 🎉")
        .setDescription(`Prize: ${prizex}\nEnds in: <t:${Math.trunc(endTimeX2.getTime()/1000)}> minutes \nWinners: ${winnersCountX}`)
